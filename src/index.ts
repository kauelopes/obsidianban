...
async function main(): Promise<void> {
  ...
  const tools: ToolDef[] = [
    ...
    { name: 'kanban_move_card',            access: 'pm',      inputSchema: s['kanban_move_card'],            description: 'Move a card to another column. Default columns: backlog, todo, in_progress, review, done. Pass input_tokens/output_tokens to record cost.', handler: async (p, c) => cards.move(p, c) },
